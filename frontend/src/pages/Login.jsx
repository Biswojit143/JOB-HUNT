...
const Login = () => {
  ...
  return (
    <section className="h-screen w-full flex items-center justify-center p-5 bg-[#0f172a] text-white">
      <div className="max-w-md w-full mx-auto custom-shadow bg-[#1e293b] p-8 rounded-xl">
        ...
        <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              id="email"
              name="email"
              className="bg-[#0f172a] border rounded-xl border-gray-600 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 px-4 py-2"
            />
          ...
          <button
            disabled={loading}
            type="submit"
            className="p-2 bg-purple-600 rounded-xl text-white cursor-pointer hover:bg-purple-700"
          >
        ...
        <p className="mt-3 text-sm text-gray-300">
          Don't have an account? <Link className="text-purple-400 underline" to={"/signup"}>Signup</Link>
        </p>
      </div>
    </section>
  )
